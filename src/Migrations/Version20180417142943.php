 ...
 */
final class Version20180417142943 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, user_creation_id INT NOT NULL, barcode INT NOT NULL, emb_code VARCHAR(100) DEFAULT NULL, name VARCHAR(150) NOT NULL, common_name VARCHAR(150) NOT NULL, date_creation DATETIME NOT NULL, quantity VARCHAR(100) DEFAULT NULL, picture VARCHAR(100) DEFAULT NULL, producer_page VARCHAR(150) DEFAULT NULL, ingredient_picture VARCHAR(100) DEFAULT NULL, ingredients VARCHAR(100) DEFAULT NULL, nutrition_picture VARCHAR(100) DEFAULT NULL, nutriscore CHAR(1), serving_size VARCHAR(100) DEFAULT NULL, energy DOUBLE PRECISION DEFAULT NULL, energy_unit CHAR(2), level_fat DOUBLE PRECISION DEFAULT NULL, level_fat_unit CHAR(2), level_satured_fat DOUBLE PRECISION DEFAULT NULL, level_satured_unit CHAR(2), level_carbohydrate DOUBLE PRECISION DEFAULT NULL, level_carbohydrate_unit CHAR(2), level_sugar DOUBLE PRECISION DEFAULT NULL, level_sugar_unit CHAR(2), level_dietary_fiber DOUBLE PRECISION DEFAULT NULL, level_dietary_fiber_unit CHAR(2), level_proteins DOUBLE PRECISION DEFAULT NULL, level_proteins_unit CHAR(2), level_salt DOUBLE PRECISION DEFAULT NULL, level_salt_unit CHAR(2), level_sodium DOUBLE PRECISION DEFAULT NULL, level_sodium_unit CHAR(2), level_alcohol DOUBLE PRECISION DEFAULT NULL, footprint_unit CHAR(2), UNIQUE INDEX UNIQ_D34A04AD97AE0266 (barcode), INDEX IDX_D34A04AD9DE46F0F (user_creation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_countries (product_id INT NOT NULL, country_id SMALLINT UNSIGNED NOT NULL, INDEX IDX_F1B088B4584665A (product_id), INDEX IDX_F1B088BF92F3E70 (country_id), PRIMARY KEY(product_id, country_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_origins (product_id INT NOT NULL, origin_id INT NOT NULL, INDEX IDX_3AE2F9634584665A (product_id), INDEX IDX_3AE2F96356A273CC (origin_id), PRIMARY KEY(product_id, origin_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_places (product_id INT NOT NULL, place_id INT NOT NULL, INDEX IDX_789CE77F4584665A (product_id), INDEX IDX_789CE77FDA6A219 (place_id), PRIMARY KEY(product_id, place_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_packagings (product_id INT NOT NULL, packaging_id INT NOT NULL, INDEX IDX_543CCBB74584665A (product_id), INDEX IDX_543CCBB74E7B3801 (packaging_id), PRIMARY KEY(product_id, packaging_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE products_brands (product_id INT NOT NULL, brand_id INT NOT NULL, INDEX IDX_F891CF1E4584665A (product_id), INDEX IDX_F891CF1E44F5D008 (brand_id), PRIMARY KEY(product_id, brand_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_alergies (product_id INT NOT NULL, alergy_id INT NOT NULL, INDEX IDX_CB2EE4594584665A (product_id), INDEX IDX_CB2EE4591114A35C (alergy_id), PRIMARY KEY(product_id, alergy_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_traces (product_id INT NOT NULL, trace_id INT NOT NULL, INDEX IDX_3CDD8C8A4584665A (product_id), INDEX IDX_3CDD8C8ABE0D4B70 (trace_id), PRIMARY KEY(product_id, trace_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE products_additives (product_id INT NOT NULL, additive_id INT NOT NULL, INDEX IDX_3049AF4A4584665A (product_id), INDEX IDX_3049AF4A384C93F0 (additive_id), PRIMARY KEY(product_id, additive_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD9DE46F0F FOREIGN KEY (user_creation_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD9DE46F0F');
