 ...
 */
final class Version20180417202704 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE products_certifications (product_id INT NOT NULL, certification_id INT NOT NULL, INDEX IDX_65E286724584665A (product_id), INDEX IDX_65E28672CB47068A (certification_id), PRIMARY KEY(product_id, certification_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
