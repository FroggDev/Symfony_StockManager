...
document.app.Scan = {
	...
	attachListeners: function() {
		 ...
		 * => Toggle mobile Torch
		 */		
		$("#button-group").on("click","button.torch",function(e) {
			e.preventDefault();
			var el = $(this);
			self.applySetting('torch',el.hasClass('off'));
			el.toggleClass('off');
		});
	...
	closeScan:function(){
		Quagga.stop();
		$("#interactive,.controls,button.torch").addClass("hidden");
	...
	detachListeners: function() {
		$("#button-group")
			.off("click", "button.stop")
			.off("click", "button.torch");
